...
const MyItemRender = (props) => {
  ...
  const goToFeedback = async () => {
    const url = `http://localhost:5000/api/getFeedbacks/${item.code}`;
    ...
    history.push("/showFeedbackDetails", {
      state: { data: response.msg },
    });
  ...
  return (
    ...
    >
      ...
      > */}
      <div className="col-6" onClick={goToFeedback}>
        <h2
          style={{
            fontSize: 14,
            color: "#454545",
